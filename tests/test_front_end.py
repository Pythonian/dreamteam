...
class TestBase(LiveServerTestCase):
	...
	def tearDown(self):
		""" Quit the websdriver and clear test database. """
		self.driver.quit()
...
class CreateObjects(object):
	"""
	Methods to be called when loggin in with
	any particular type of user
	"""
...
class TestLogin(TestBase):
	...
	def test_login(self):
		"""
		Test that a user can login and that they will be redirected
		to the homepage.
		"""
	...
	def test_admin_login(self):
		"""
		Test that an admin user can login and that they will be redirected
		to the admin page
		"""
	...
	def test_login_invalid_email_format(self):
		"""
		Test thata user cannot login using an invalid
		email format that an appropriate error message will be displayed
		"""
	...
	def test_login_wrong_password(self):
		...
		and that an appropriate message will be displayed
		"""
...
class TestDepartments(CreateObjects, TestBase):
	...
	def test_add_existing_department(self):
		"""
		Test that an admin user cannot add a department
	...
	def test_edit_department(self):
		...
		self.driver.find_element_by_class_name("edit-department").click()
		time.sleep(1)
	...
	def test_delete_department(self):
		...
		self.driver.find_element_by_class_name("delete-department").click()
		time.sleep(1)
...
class TestRoles(CreateObjects, TestBase):
	...
	def test_add_existing_role(self):
		"""
		Test that an admin user cannot add a role with
	...
	def test_edit_role(self):
		...
		self.driver.find_element_by_class_name("edit-role").click()
		time.sleep(1)

		# Fill in edit role form
		self.driver.find_element_by_id("name").clear()
		self.driver.find_element_by_id("name").send_keys("Edited name")
		self.driver.find_element_by_id("description").clear()
		self.driver.find_element_by_id("description").send_keys(
	...
	def test_delete_role(self):
		...
		# Click on edit role link
		self.driver.find_element_by_class_name("delete-role").click()
		time.sleep(1)
...
class TestEmployees(CreateObjects, TestBase):
	...
	def test_assign(self):
		"""
		Test that an admin user can assign a role and a 
...
class TestPermissions(CreateObjects, TestBase):
	"""
	Tests to ensure that non-admin users cannot view
	protected pages
	"""
	...
	def test_permissions_add_department_page(self):
		"""
		Test that non-admin users cannot access the add
		department page
		"""
