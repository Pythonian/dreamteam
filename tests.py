...
class TestBase(TestCase):
    ...
    def setUp(self):
        ...
        admin = Employee(username="admin",
                         password="admin2016", is_admin=True)

        # create test non-admin user
        employee = Employee(username="test_user",
                            password="test2016")
...
class TestModels(TestBase):
    ...
    def test_role_model(self):
        ...
        # create test role
        role = Role(name="CEO", description="Chief Executive Officer")
...
class TestViews(TestBase):
    ...
    def test_list_departments_view(self):
        """
...
class TestErrorPages(TestBase):
    ...
    def test_403_forbidden(self):
        ...
        self.assertTrue(bytes('403 Error'.encode('utf-8')) in response.data)
        self.assertTemplateUsed('errors/403.html')

    def test_404_not_found(self):
        response = self.client.get('/nothinghere/')
        self.assertEqual(response.status_code, 404)
        self.assertTrue(bytes('404 Error'.encode('utf-8')) in response.data)
    ...
    def test_500_internal_server_error(self):
        ...
        self.assertTrue(bytes('500 Error'.encode('utf-8')) in response.data)
